...
List<QuickAction> mockContent = [
  new QuickAction()
    ...
    ..url = ''
    ..description = 'Answer five quick questions to find information relevant to you'
    ..imgSrc = '/pics/header_silver_service_us.jpg',
  new QuickAction()
    ..icon = 'timelapse'
    ..name = 'Self estimation'
    ..description = 'How long will it take for you to manage your quicksilver amalgam?'
    ..url = ''
    ..imgSrc = '/pics/quicksilver_management.jpg',
  new QuickAction()
    ..icon = 'gavel'
    ..name = 'Laws and regulations'
    ..description = 'Here you can find out what laws and regulations are in force'
    ..url = ''
